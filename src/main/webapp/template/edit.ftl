...
<#include "/include/header.ftl"><div class="g-doc">
    ...
    <#else>
    <div class="n-public">
        <form class="m-form m-form-ht" id="form" method="post" action="/study/editSubmit?id=${product.id}" onsubmit="return false;" autocomplete="off">
            <div class="fmitem">
...
<script type="text/javascript" src="/study/js/public.js"></script>
</body>
</html>